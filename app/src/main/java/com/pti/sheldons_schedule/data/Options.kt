...
@Parcelize
sealed class Options(val title: Int, val nameId: Int) : Parcelable {
    @Parcelize
    ...
    @Parcelize
    sealed class Reminder(val name: Int, val alias: String, val value: Long) : Options(R.string.remind, name) {
